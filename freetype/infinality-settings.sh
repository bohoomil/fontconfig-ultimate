...
### custom settings by bohoomil, rev. 0.2, for freetype2 v. 2.4.12 ###
### http://bohoomil.cu.cc ###
...
export INFINALITY_FT_FILTER_PARAMS="14 24 38 24 14" # well balanced
export INFINALITY_FT_GRAYSCALE_FILTER_STRENGTH="0"
export INFINALITY_FT_FRINGE_FILTER_STRENGTH="0"
export INFINALITY_FT_AUTOHINT_HORIZONTAL_STEM_DARKEN_STRENGTH="20"
...
export INFINALITY_FT_GAMMA_CORRECTION="15 125"
